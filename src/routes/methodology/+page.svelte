<script>
  ...
  <section id="approach">
    <h2>Approach</h2>
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc id ipsum euismod, rhoncus orci at, varius diam. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Vivamus et ante turpis. Vivamus sit amet erat luctus, lacinia justo congue, lacinia eros. Phasellus rhoncus leo ac tortor aliquam, ac finibus augue luctus. Nam a blandit purus. Donec auctor semper nulla, ac consectetur enim sagittis quis. Proin tristique nisl tortor, euismod blandit lectus imperdiet id. Curabitur ac urna dignissim, eleifend lectus eu, tincidunt libero. Suspendisse potenti. Sed fermentum libero mollis, imperdiet sapien ac, dictum nisl.
    </p>
    <p style="margin-bottom: 1rem;"> We train these models on two versions of the dataset:</p>  
        <ol>
            <li>Initial/Original chest X-rays (underwent some basic preprocessing?)</li>
            <li>Preprocessed images (using _______)</li>
