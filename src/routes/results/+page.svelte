<script>
  ...
  <section id="discussion">
    <h2>Discussion</h2>
    <p>We employ pre-trained convolutional neural networks (CNNs) such as DenseNet and ResNet for multi-label classification. 
        ...
        We utilize Grad-CAM visualizations to identify which regions of the chest X-ray images contribute most to model predictions, offering valuable insights into decision-making processes.
    </p>
  </section>
